...
<div class="form-group col-md-12">
    ...
    <div class="row" id="address-{{ $field['name'] }}">
        <div class="col-sm-6 col-md-6 mb-3">
            ...
            <select class="form-control" @change="cityChange" v-model="frm.city"
        ...
        <div class="col-sm-6 col-md-6">
            ...
            <select class="form-control " @change="districChange" v-model="frm.distric"
        ...
        <div class="col-sm-6 col-md-6">
            ...
            <select class="form-control no-error-border" @change="communeChange" v-model="frm.commune"
        ...
        <div class="col-sm-6 col-md-6">
            ...
            <select class="form-control no-error-border" @change="villageChange" v-model="frm.village"
